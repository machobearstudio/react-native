...
- (void)textFieldNextAndPrevSubmitEditing:(NSString *)string
{
  _submitted = YES;
  [_eventDispatcher sendTextEventWithType:RCTTextEventTypeSubmit
                                 reactTag:self.reactTag
...
- (void)handleNextButtonFromInputAccessory {
    [self textFieldNextAndPrevSubmitEditing:@"Next"];
    _blurOnSubmit = YES;
}
- (void)handlePrevButtonFromInputAccessory {
   
    [self textFieldNextAndPrevSubmitEditing:@"Prev"];
    _blurOnSubmit = YES;
}
