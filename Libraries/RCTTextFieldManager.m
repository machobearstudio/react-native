...
RCT_CUSTOM_VIEW_PROPERTY(showToolBar, BOOL, RCTTextField)
{
  if (json && ([RCTConvert BOOL:json])) {
    ...
    UIBarButtonItem* nextButton = [[UIBarButtonItem alloc]
                                   ...
                                   target:view action:@selector(handleNextButtonFromInputAccessory)];
    UIBarButtonItem* prevButton = [[UIBarButtonItem alloc]
                                   initWithTitle:@" 〈"
                                   style:UIBarButtonItemStylePlain
                                   target:view action:@selector(handlePrevButtonFromInputAccessory)];
    toolbar.items = @[prevButton, nextButton, flex, doneButton];
